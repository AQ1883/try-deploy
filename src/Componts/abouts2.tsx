    ...
    <div className="container mx-auto flex justify-center items-center h-screen">
      <div ref={ref} className={styles.container}>
        <Trail open={open}>
          ...
          <span>the leading company in the field of smart grocerystores</span>
          <span> in the Kingdom of Saudi Arabia In a world full</span>

          <span> of templates and monotonous words we strive to spark </span>
          <span>
            creativity and deliver innovative shopping
          </span>
